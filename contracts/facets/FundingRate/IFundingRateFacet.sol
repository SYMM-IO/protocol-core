...
interface IFundingRateFacet is IFundingRateEvents {
	...
	function setFundingFee(uint256[] memory symbolIds, int256[] memory longFees, int256[] memory shortFees, int256[] memory marketPrices) external;
	function setShortFundingFee(uint256[] memory symbolIds, int256[] memory shortFees, int256[] memory marketPrices) external;
